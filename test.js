var specify = s = require('specify')
var Buffer = require('buffer').Buffer
var events = require('events')
var filters = process.argv.slice(2)
var ns = require('./')

s('nsPayloadLength', function (as) {
